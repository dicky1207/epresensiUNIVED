            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/panel/konfigurasi/updatelokasikantor" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-2">
                                        <span class="input-icon-addon">
                                            ...
                                            <path d="M9 4v13" /><path d="M15 7v5.5" /><path d="M21.121 20.121a3 3 0 1 0 -4.242 0c.418 .419 1.125 1.045 2.121 1.879c1.051 -.89 1.759 -1.516 2.121 -1.879z" />
                                            <path d="M19 18v.01" />
                                            </svg>
                                        </span>
                                        <input type="text" value="{{ $lok_kantor->lokasi_kantor }}" class="form-control" id="lokasi_kantor" name="lokasi_kantor" placeholder="Titik Koordinat">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
