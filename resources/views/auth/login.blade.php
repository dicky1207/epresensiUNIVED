...
<head>
    ...
    <style>
        ...
        .form-button-group .btn {
            width: 100%; /* Membuat tombol memiliki lebar otomatis */
            max-width: 368px; /* Mengatur lebar maksimum tombol */
            margin: 0 auto; /* Memusatkan tombol */
            display: block; /* Menjadikan tombol sebagai blok untuk margin otomatis */
        }
    </style>
</head>
...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1" id="login-form">
            <div class="section">
