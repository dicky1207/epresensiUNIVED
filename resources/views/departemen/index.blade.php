                                        ...
                                        @foreach ($departemen as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <div>
                                                        <a href="#" class="edit btn btn-warning btn-sm" kode_dept="{{ $d->kode_dept }}">
                                                        ...
                                                        <div>
                                                        <form action="/panel/departemen/{{ $d->kode_dept }}/delete" method="POST" style="margin-left: 8px">
                                                            @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/panel/departemen/store" method="POST" id="frmDepartemen" name="frmDepartemen">
            @csrf
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="input-icon mb-2">
                        <span class="input-icon-addon">
                            ...
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21l18 0" /><path d="M9 8l1 0" />
                            <path d="M9 12l1 0" /><path d="M9 16l1 0" /><path d="M14 8l1 0" /><path d="M14 12l1 0" />
