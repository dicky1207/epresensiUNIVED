            ...
            <div class="row mt-2">
                <div class="col-12">
                    <div class="input-group mb-2">
                        <input type="text" readonly value="" class="form-control" id="password" name="password" placeholder="Password Otomatis">
                        <button type="button" class="btn btn-success" id="generatePassword">Generate Password</button>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
